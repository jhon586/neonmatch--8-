...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = "relative w-full px-4 py-3 rounded-xl font-bold transition-all duration-200 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2";
